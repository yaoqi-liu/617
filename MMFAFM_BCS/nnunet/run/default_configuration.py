...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
    ...
    print(base_module, network_trainer) # nnunet.training.network_training MAML3_channelTrainerV2BraTSRegions
    # "search_in : ('/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/A2FSeg-main/nnunet', 'training', 'network_training')"
    trainer_class = recursive_find_python_class([join(*search_in)], network_trainer,current_module=base_module)
    # '/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/A2FSeg-main/data/RESULTS_FOLDER/nnUNet/3d_fullres/Task082_BraTS2020/MAML3_channelTrainerV2BraTSRegions__nnUNetPlansv2.1_batch_01'
    ...
    print("My trainer class is: ", trainer_class) # <class 'nnunet.training.network_training.MAML3_channelTrainerV2BraTSRegions.MAML3_channelTrainerV2BraTSRegions'>
    ...
    if (network == '2d' or len(possible_stages) > 1) and not network == '3d_lowres':
        ...
        batch_dice = False
        print("I am using sample dice + CE loss")  # that

    # /media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/A2FSeg-main/data/nnUNet_preprocessed/Task082_BraTS2020/nnUNetData_plans_v2.1
