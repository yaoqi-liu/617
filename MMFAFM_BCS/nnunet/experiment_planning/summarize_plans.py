...
def summarize_plans(file):
    ...
    print("num_classes: ", plans['num_classes']) # 3
    print("modalities: ", plans['modalities']) # {0: 'T1', 1: 'T1ce', 2: 'T2', 3: 'FLAIR'}
    print("use_mask_for_norm", plans['use_mask_for_norm']) # OrderedDict([(0, True), (1, True), (2, True), (3, True)])
    print("keep_only_largest_region", plans['keep_only_largest_region']) # None
    print("min_region_size_per_class", plans['min_region_size_per_class']) # None
    print("min_size_per_class", plans['min_size_per_class']) # None
    print("normalization_schemes", plans['normalization_schemes']) # OrderedDict([(0, 'nonCT'), (1, 'nonCT'), (2, 'nonCT'), (3, 'nonCT')])
    print("stages...\n")

    """
    {'batch_size': 1, 'num_pool_per_axis': [5, 5, 5], 'patch_size': array([128, 128, 128]), 
    'median_patient_size_in_voxels': array([139, 170, 138]), 'current_spacing': array([1., 1., 1.]), 
    'original_spacing': array([1., 1., 1.]), 'do_dummy_2D_data_aug': False, 
