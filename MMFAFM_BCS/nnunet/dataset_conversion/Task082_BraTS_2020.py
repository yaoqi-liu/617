...
sys.path.append('/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/A2FSeg-main')
...
if __name__ == "__main__":
    ...
    downloaded_data_dir = "/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/A2FSeg-main/data/archive/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData"
    ...
    target_imagesTr = join(target_base, "images")
    target_imagesVal = join(target_base, "imagesVal")
    target_imagesTs = join(target_base, "imagesTs")
    target_labelsTr = join(target_base, "labels")
...
# endregion
    ...
    json_dict['training'] = [{'image': "./images/%s.nii" % i, "label": "./labels/%s.nii" % i} for i in
                             train_patient_names]
    json_dict['val'] = [{'image': "./imagesVal/%s.nii" % i, "label": "./labelsVal/%s.nii" % i} for i in
                             val_patient_names]
