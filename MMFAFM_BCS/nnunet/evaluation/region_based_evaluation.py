...
def get_brats_regions():
    ...
    """
    regions = {
        "whole tumor": (1, 2, 3), # "whole tumor"（全肿瘤）：对应的标签为 (1, 2, 3)
        "tumor core": (2, 3), # "tumor core"（肿瘤核心）：对应的标签为 (2, 3)
        "enhancing tumor": (3,) # "enhancing tumor"（增强肿瘤）：对应的标签为 (3,)
    }
    return regions
